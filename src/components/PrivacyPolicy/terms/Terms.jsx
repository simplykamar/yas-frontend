    ...
    return(
        <div className="container">
                ...
                <ol className="">
                    ...
                    <li className="">
                    <p>If the user has any questions, doubts or confusion in regard to any of the terms & conditions set out herein, he should seek clarifications from us through email support@yas.com and should wait for a written clarification before using the service</p>
                    </li>
                    <li className="">
