	...
	<div className="my-5">
				...
				<div className="row mt-5">
					<div className="col-lg-3 col-md-3 col-sm-6 col-6 mb-lg-0 mb-md-0 mb-3">
						<img src={forher} className="img-fluid rounded-4"/>
					</div>
					<div className="col-lg-3 col-md-3 col-sm-6 col-6 mb-lg-0 mb-md-0 mb-3 ">
						<img src={flowers} className="img-fluid rounded-4"/>
					</div>
					<div className="col-lg-3 col-md-3 col-sm-6 col-6 mb-lg-0 mb-md-0 mb-3">
						<img src={couples} className="img-fluid rounded-4"/>
					</div>
					<div className="col-lg-3 col-md-3 col-sm-6 col-6 mb-lg-0 mb-md-0 mb-3">
						<img src={husband} className="img-fluid rounded-4"/>
					</div>
				</div>

				<div className="row mt-3">
					<div className="col-lg-3 col-md-3 col-sm-6 col-6 mb-lg-0 mb-md-0 mb-3">
						<img src={cakes} className="img-fluid rounded-4"/>
					</div>
					<div className="col-lg-3 col-md-3 col-sm-6 col-6 mb-lg-0 mb-md-0 mb-3">
						<img src={personalized} className="img-fluid rounded-4"/>
					</div>
					<div className="col-lg-3 col-md-3 col-sm-6 col-6 mb-lg-0 mb-md-0 mb-3">
						<img src={wife} className="img-fluid rounded-4"/>
					</div>
					<div className="col-lg-3 col-md-3 col-sm-6 col-6 mb-lg-0 mb-md-0 mb-3 ">
						<img src={forhim} className="img-fluid rounded-4"/>
					</div>
				</div>
	</div>
		)
